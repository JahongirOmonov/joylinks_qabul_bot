...
from bot.handlers.users.main import start, sms_for_admin, sms_received, echo, echo_photo, echo_video, \
    sms_for_banned_user, confirm_callback, get_ism, get_familiya, get_telraqam
...
def prepare_router() -> Router:
    ...
    router.message.register(get_ism, states.main.RegisteredUsersState.ism_s)
    router.message.register(get_familiya, states.main.RegisteredUsersState.familiya_s)
    router.message.register(get_telraqam, states.main.RegisteredUsersState.telefon_s)
